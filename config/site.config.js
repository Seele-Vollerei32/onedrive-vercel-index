...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Kevin@atunemic.onmicrosoft.com',
  ...
  email: 'mailto:we123445@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Seele-Vollerei32/',
    },
  ],
